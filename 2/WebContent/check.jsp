...
window.onload = function() {
   ...
   <form action="select" method="post">
       <table width="101%" class="table table-bordered">
           ...
           <input name="submit" type="submit" class="btn btn-info  " style="width:80px;" value="按库存查询" />
             </td>
           </tr>
         </table>
       ...
       <c:forEach var="goods" items="${requestScope.list}">
           ...
           <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>${Goods.Number}</strong></td>
           <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>${goods.type}</strong></td>
           <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>${goods.material}</strong></td>
           <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>${goods.brand}</strong></td>
           <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>${goods.price}</strong></td>
           <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>${goods.quantity}</strong></td>
          </tr>  
      </c:forEach> 
